...
public abstract class ProxyAutomobile implements Serializable, Debuggable {
	...
	public void addAuto(String MMY, String name) {
		if (auto.getMakeModelYear().equalsIgnoreCase(MMY) && auto.getOwner().equalsIgnoreCase(name)) {
			fleet.addAuto(MMY, auto);
		} else
			System.out.println("That Automobile doesnt exist");
